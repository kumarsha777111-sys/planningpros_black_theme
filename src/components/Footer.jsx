  ...
  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          duration: 0.6
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">Planning Pros <span className="whitespace-nowrap">&amp; Consultant</span></span>
            </div>
          ...
          >
            <span className="text-base font-semibold mb-1.5">Why Choose Us?</span>
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              <div className="bg-slate-800 rounded-md p-3 text-center">
                <span className="block text-xl font-bold text-blue-400">10+</span>
                <span className="text-slate-400 text-xs">Years Experience</span>
              </div>
              <div className="bg-slate-800 rounded-md p-3 text-center">
                <span className="block text-xl font-bold text-blue-400">100+</span>
                <span className="text-slate-400 text-xs">Clients Served</span>
              </div>
              <div className="bg-slate-800 rounded-md p-3 text-center">
                <span className="block text-xl font-bold text-blue-400">50+</span>
                <span className="text-slate-400 text-xs">Expert Consultants</span>
              </div>
              <div className="bg-slate-800 rounded-md p-3 text-center">
                <span className="block text-xl font-bold text-blue-400">24/7</span>
          ...
          delay: 0.4
            ...
            <ul className="space-y-3">
              {legal.map((item, index) => <li key={index}>
                  <button onClick={handleLinkClick} className="text-slate-300 text-sm hover:text-white transition-colors text-left">
                    {item}
                  </button>
                </li>)}
            </ul>
            <div className="pt-4">
              <span className="text-base font-semibold block mb-3">Follow Us</span>
        ...
        duration: 0.6,
        delay: 0.4
      }} className="border-t border-slate-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-slate-400 text-sm text-center md:text-left">
            © 2024 Planning Pros <span className="whitespace-nowrap">&amp; Consultant</span>. All rights reserved.
          </p>
          <div className="flex items-center space-x-5 text-slate-400 text-sm">
